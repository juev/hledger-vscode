...
`;
      ...
      expect(config.getAccounts()).toEqual(
        expect.arrayContaining(['Assets:Bank', 'Expenses:Food', 'Активы:Наличные'])
      );
...
`;
      ...
      expect(config.getCommodities()).toEqual(expect.arrayContaining(['RUB', 'USD', 'EUR']));
    });
...
`;
      ...
      expect(config.getUsedAccounts()).toEqual(
        expect.arrayContaining(['Assets:Cash', 'Expenses:Food', 'Активы:Наличные'])
      );
    });
...
`;
      ...
      expect(config.getUndefinedAccounts()).toEqual(
        expect.arrayContaining(['Assets:Cash', 'Expenses:Food'])
      );
