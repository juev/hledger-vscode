...
import { JournalNotFoundError, JournalAccessError, isJournalError } from '../import/types';
...
describe('HLedgerImportCommands', () => {
  ...
  describe('custom error types', () => {
    ...
    describe('JournalAccessError', () => {
      it('should have correct name property', () => {
        const error = new JournalAccessError('/path/to/journal.hledger', 'Permission denied');
