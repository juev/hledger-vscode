 ...
 */
export function isJournalError(error: unknown): error is JournalNotFoundError | JournalAccessError {
  return error instanceof JournalNotFoundError || error instanceof JournalAccessError;
}
...
export type AccountResolutionSource = 'category' | 'history' | 'pattern' | 'sign' | 'default';
